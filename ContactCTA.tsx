...
export default function ContactCTA() {
  return (
    <section className="py-28 relative overflow-hidden bg-[oklch(0.09_0.005_264)]">
      {/* Background gradient */}
      ...
      <div className="relative z-10 container">
        ...
        >
          ...
          <p className="text-[oklch(0.50_0.010_264)] text-lg leading-relaxed mb-10 max-w-xl mx-auto" style={{ fontFamily: "'DM Sans', sans-serif" }}>
